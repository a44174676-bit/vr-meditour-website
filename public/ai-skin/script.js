(function () {
  ...
  function completePremiumQrUnlock(modal) {
    stopQrScanner();
    modal?.remove();
        ...
        try {
          ...
          if (raw) {
            if (isValidPremiumQr(raw)) {
              ...
              completePremiumQrUnlock(document.getElementById('vrmtQrScanModal'));
              return;
            }
  ...
  function openQrScannerModal() {
    ...
    modal.querySelector('#vrmtQrPremiumViewBtn')?.addEventListener('click', () => completePremiumQrUnlock(modal));
